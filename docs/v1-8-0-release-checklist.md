...
| B 跨轮复读结构修复 | W2 盲评 10:11:4 未优；多轮组仍为 B 胜区 | W3 / v1.9.0 候选 |
| 输出侧全量语义风险检测 | F2-c 运行时门仅覆盖 8/370；P29/P36/P39 真阳性漏拦 | W3 / v1.9.0 候选 |
| 4-gram 红线重校 | 三臂全红但唯一多轮盲评组 B 胜；指标与身份检测正交 | W3 |
