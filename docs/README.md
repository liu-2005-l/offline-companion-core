...
| **拟人表述 W2 三臂规格** | [`oc-persona-expression-w2-spec.md`](./oc-persona-expression-w2-spec.md) | — |
| **拟人表述 W2 三臂报告** | [`oc-persona-expression-w2-report.md`](./oc-persona-expression-w2-report.md) | — |
| **人格约束体系 P 批 v1.5** | [`persona-constraint-batch-design-v1_5.md`](./persona-constraint-batch-design-v1_5.md) | — |
| **人格约束体系 P1 执行规格** | [`persona-constraint-p1-spec.md`](./persona-constraint-p1-spec.md) | — |
...
| **人格约束 P3 接线批规格草案** | [`persona-constraint-p3-wiring-spec-draft.md`](./persona-constraint-p3-wiring-spec-draft.md) | — |
| **人格约束 P3-0 数值与机器语义锚草案** | [`persona-constraint-p3-0-numeric-anchor-spec-draft.md`](./persona-constraint-p3-0-numeric-anchor-spec-draft.md) | — |
| **人格约束 P3-0 L2 标定判定线草案** | [`persona-constraint-p3-0-l2-calibration-verdict-draft.md`](./persona-constraint-p3-0-l2-calibration-verdict-draft.md) | — |
...
| **人格约束 P3-A1.1 闭合修正规格** | [`persona-constraint-p3-a1-1-correction-spec.md`](./persona-constraint-p3-a1-1-correction-spec.md) | — |
| **人格约束 P3-A2 L1 组装与资产补全规格（已闭合）** | [`persona-constraint-p3-a2-assembly-spec-draft.md`](./persona-constraint-p3-a2-assembly-spec-draft.md) | — |
| **人格约束 P3-A3 L3 谓词与 lint 归并规格（已锚定）** | [`persona-constraint-p3-a3-l3-predicate-spec-draft.md`](./persona-constraint-p3-a3-l3-predicate-spec-draft.md) | — |
